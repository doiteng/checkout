...
- uses: actions/checkout@v6
  with:
    ...
    # Path to a local bare git mirror to use as an alternates object store. If the
    # path exists, git will resolve objects from it first, reducing network traffic.
    # If it does not exist, the checkout proceeds normally.
    # Default: 
    mirror-path: ''
```
<!-- end usage -->
